...
@section('title', 'Fasilitasfp Indekost')
  ...
  <div class="row">
    ...
    <table class="table">
        ...
        $i=0;
            ...
            $filterprimer = "SELECT * WHERE { ?s indekost:Memiliki indekost:".$idfp.". ?s indekost:Foto ?o. ?s indekost:Harga ?p. ?s indekost:Alamat ?q}";
            $qrfilter = $sparql->query($filterprimer);
            
            foreach($qrfilter as $item){
            $idtampilfp = str_replace('http://www.semanticweb.org/msi/ontologies/2021/0/ta-ontology-23#','',$item->s->getUri());
        ...
        <div class="col-lg-3 col-6">
         <div class="card" style="width: 18rem;">
           ...
           <img src="{{ URL::asset('images/'.$queryfoto) }}" class="card-img-top" alt="..." width="150px" height="200px">
             ...
             <div class="card-body">
                <h5 class="card-title"><?php echo $idtampilfp ?></h5>       
            </div>
            ...
            <div class="card-body">
                 <a href="{{ route ('detaillokasi.show',[$idtampilfp]) }}" class="card-link">Detail Indekost--> </a>
            </div>
